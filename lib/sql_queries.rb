...
"SELECT projects.title, SUM(pledges.amount) AS total_pledges - projects.funding_goal FROM projects
JOIN pledges ON projects.id = pledges.project_id
GROUP BY projects.title HAVING total_pledges >= projects.funding_goal"
end
